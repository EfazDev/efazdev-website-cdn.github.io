...
if os.path.exists("logger_word.json"):
    with open("logger_word.json") as f:
        blacklisted_words = json.loads(f.read())
    blacklisted_words = blacklisted_words["BlacklistedWords"]

    with open("logger_word.json") as f:
        whitelisted_words = json.loads(f.read())
    whitelisted_words = whitelisted_words["WhitelistedWords"]
    if __name__ == '__main__' and hideBackgroundConsole == False:
...
if __name__ == '__main__':
    ...
    printWarnMessage("Script Version v1.0.1")
